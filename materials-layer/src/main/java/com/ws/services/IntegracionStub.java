...
//	private static String servicesServer = "http://localhost:8080/axis2/services/";
	...
	com.ws.services.IntegracionStub.ActualizarDatos actualizarDatos9)
...

	{
		...
		try {
			...
			env = toEnvelope(getFactory(_operationClient.getOptions().getSoapVersionURI()), actualizarDatos9, optimizeContent(new javax.xml.namespace.QName(
	...
	com.ws.services.IntegracionStub.SeleccionarDatos seleccionarDatos11)
...

	{
		...
		try {
			...
			env = toEnvelope(getFactory(_operationClient.getOptions().getSoapVersionURI()), seleccionarDatos11, optimizeContent(new javax.xml.namespace.QName(
	...
	com.ws.services.IntegracionStub.GuardarDatos guardarDatos13)
...

	{
		...
		try {
			...
			env = toEnvelope(getFactory(_operationClient.getOptions().getSoapVersionURI()), guardarDatos13, optimizeContent(new javax.xml.namespace.QName(
	...
	com.ws.services.IntegracionStub.EliminarArchivo eliminarArchivo15)
...

	{
		...
		try {
			...
			env = toEnvelope(getFactory(_operationClient.getOptions().getSoapVersionURI()), eliminarArchivo15, optimizeContent(new javax.xml.namespace.QName(
