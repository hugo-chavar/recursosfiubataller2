...
public class IntegracionStub extends org.apache.axis2.client.Stub {
	...
	public static class ReturnedObject implements org.apache.axis2.databinding.ADBBean {
		/*
		 * This type was generated from the piece of schema that had name =
		 * ReturnedObject Namespace URI =
		 * http://ws.datalayer.redsocedu.fiuba.ar/xsd Namespace Prefix = ns1
		 */
		...
		public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType)
			...
			if (serializeType) {
				...
				java.lang.String namespacePrefix = registerPrefix(xmlWriter, "http://ws.datalayer.redsocedu.fiuba.ar/xsd");
				if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
					writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":ReturnedObject", xmlWriter);
				} else {
					writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ReturnedObject", xmlWriter);
				}

			}
			if (localIdTracker) {
				namespace = "http://ws.datalayer.redsocedu.fiuba.ar/xsd";
		...
		private static java.lang.String generatePrefix(java.lang.String namespace) {
			if (namespace.equals("http://ws.datalayer.redsocedu.fiuba.ar/xsd")) {
				return "ns1";
			}
			return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
		}
		...
		public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
			...
			if (localIdTracker) {
				elementList.add(new javax.xml.namespace.QName("http://ws.datalayer.redsocedu.fiuba.ar/xsd", "id"));
		...
		public static class Factory {
			 ...
			 * positioned at the end element of its outer element
			 */
			public static ReturnedObject parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
				...
				try {
					...
					if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
						...
						if (fullTypeName != null) {
							...
							if (!"ReturnedObject".equals(type)) {
								// find namespace for the prefix
								java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
								return (ReturnedObject) ExtensionMapper.getTypeObject(nsUri, type, reader);
							}
					...
					if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.datalayer.redsocedu.fiuba.ar/xsd", "id").equals(reader.getName())) {
	...
	public static class SeleccionarArchivoResponse implements org.apache.axis2.databinding.ADBBean {
		...
		protected ReturnedObject[] local_return;
		 ...
		 */
		public ReturnedObject[] get_return() {
			return local_return;
		}
		 ...
		 */
		protected void validate_return(ReturnedObject[] param) {
		 ...
		 *            _return
		 */
		public void set_return(ReturnedObject[] param) {
		 ...
		 *            ReturnedObject
		 */
		public void add_return(ReturnedObject param) {
			if (local_return == null) {
				local_return = new ReturnedObject[] {};
			}
			...
			list.add(param);
			this.local_return = (ReturnedObject[]) list.toArray(new ReturnedObject[list.size()]);
				...
				try {
					...
					if (reader.isStartElement() && new javax.xml.namespace.QName("http://services.ws.com", "return").equals(reader.getName())) {
						...
						if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
							...
							list1.add(ReturnedObject.Factory.parse(reader));
						}
						...
						object.set_return((ReturnedObject[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(ReturnedObject.class, list1));
	...
	public static class ExtensionMapper {
		...
		public static java.lang.Object getTypeObject(java.lang.String namespaceURI, java.lang.String typeName, javax.xml.stream.XMLStreamReader reader)
			...
			if ("http://ws.datalayer.redsocedu.fiuba.ar/xsd".equals(namespaceURI) && "ReturnedObject".equals(typeName)) {

				return ReturnedObject.Factory.parse(reader);
