...
\textbf{Además, tener en cuenta que las respuestas en las preguntasConOpciones arrancan en 1, y no en 0 como se hab\'ia definido inicialmente, quedando sus posibles valores definidos entre 1 y la cantidad de respuestasPosibles.  } \newline
