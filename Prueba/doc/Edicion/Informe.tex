...
\begin{itemize}
\item idUsuario: es un atributo entero que permite relacionar la encuesta respondida con el usuario que se encargo de completarla.\\
\begin{itemize}
\item Tipo De Datos : Integer
\item Longitud : 20
\end{itemize}
...
\subparagraph{Pregunta Respuesta Fija Respondida} \
...
\subparagraph{Pregunta Respuesta a Completar Respondida} \
