...
\item PreguntaRespuestaACompletar : Son preguntas donde la respuesta esperada es una descripci\'on.En el prototipo corresponde a la pregunta 3.
\end{enumerate}
