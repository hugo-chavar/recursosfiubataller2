...
//		}
		...
		xml = "<parametro><recurso><tipo>Link</tipo></recurso></parametro>";
		pruebaGetRecurso();
		// prueba q da error por definir tipo inexistente
		xml = "<parametro><recurso><recursoId>1003</recursoId><tipo>abcd</tipo></recurso></parametro>";
		pruebaGetRecurso();

		// prueba Ok de cache
		xml = "<parametro><recurso><recursoId>1003</recursoId><tipo>Encuesta</tipo></recurso></parametro>";
		pruebaGetRecurso();
		
		// prueba Ok de cache de nuevo
		xml = "<parametro><recurso><recursoId>1004</recursoId><tipo>Encuesta</tipo></recurso></parametro>";
		pruebaGetRecurso();
		
		// prueba con datos mockeados de integracion
		xml = "<parametro><recurso><recursoId>15</recursoId><tipo>Encuesta</tipo></recurso></parametro>";
		pruebaGetRecurso();
		...
		xml = "<parametro><recurso><recursoId>15</recursoId></recurso><usuarioId>4</usuarioId></parametro>";
		pruebaGetRespondida();
		
		// Prueba get otra Respondida con parametros validos de cache
		xml = "<parametro><recurso><recursoId>10</recursoId></recurso><usuarioId>5</usuarioId></parametro>";
		pruebaGetRespondida();
		...
		xml = "<parametro><recurso><recursoId>20</recursoId></recurso><usuarioId>4</usuarioId></parametro>";
		pruebaGetRespondida();
		
		// Prueba get otra Respondida con parametros validos de cache
		// conteniendo respuestas multiples
		xml = "<parametro><recurso><recursoId>18</recursoId></recurso><usuarioId>5</usuarioId></parametro>";
		pruebaGetRespondida();
		
		// Prueba get otra Respondida con parametros validos de cache
		// conteniendo respuestas vacias
		xml = "<parametro><recurso><recursoId>19</recursoId></recurso><usuarioId>5</usuarioId></parametro>";
		pruebaGetRespondida();
		
		// Prueba get Respondida sin especificar recursoId
		xml = "<parametro><usuarioId>4</usuarioId></parametro>";
		pruebaGetRespondida();
		
		// Prueba get Respondida sin especificar usuarioId
		xml = "<parametro><recurso><recursoId>15</recursoId></recurso></parametro>";
		pruebaGetRespondida();
...
//		xml = "<parametro><ambitoId>15</ambitoId><usuarioId>23</usuarioId>" + xmlEncuesta + "</parametro>";
//		
